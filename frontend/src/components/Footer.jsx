    ...
    <footer className="site-footer">
      ...
      <div className="also-available fade-in-up">
        ...
        <div className="platform-logos">
          ...
          <a href="https://www.google.com/travel/hotels/entity/ChkQitTc5KLXwLI-Gg0vZy8xMXZ6MmZfMXc2EAI" target="_blank" rel="noopener noreferrer" className="platform-link" aria-label="Google Hotels">
